...
from posts.views import CreatePost,ListPosts,MyPosts,CreateAnswer,CreateComment,LikeCreateAPIView
...
urlpatterns = [
    ...
    path('answers/like', LikeCreateAPIView.as_view(), name='liked'),
]
